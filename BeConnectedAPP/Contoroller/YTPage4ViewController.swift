...
class YTPage4ViewController: UITableViewController,SegementSlideContentScrollViewDelegate {
    ...
    func getData() {
        ...
        var text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyBgz3Lj-n_qhGWXJFLJL6F_KNITXrvKakQ&q=ニュース&part=snippet&maxResults=40&order=date"
