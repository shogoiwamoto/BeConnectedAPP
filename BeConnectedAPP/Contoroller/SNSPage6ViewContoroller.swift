...
class SNSPage6ViewContoroller: UITableViewController,SegementSlideContentScrollViewDelegate  {
    ...
    func featcData() {
       ...
       var reference = Database.database().reference().child("Pets").observe(.value) { (snapshot) in
