...
class YTPage3ViewController: UITableViewController,SegementSlideContentScrollViewDelegate {
    ...
    func getData() {
        ...
        var text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDFpdsuZ9DDXZVXC5QUWjP4wwSjyaHkuFs&q=ファッション&part=snippet&maxResults=30&order=date"
