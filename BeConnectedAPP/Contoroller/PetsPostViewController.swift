...
class PetsPostViewController: UIViewController {
    ...
    @IBAction func PetsPostAction(_ sender: Any) {
    
    var timeLineDB = Database.database().reference().child("Pets").childByAutoId()
